// Dekker Solution 3 : Using flags for entry and exit (of critical section) for synchronization 
//but to re-ensure mutual exclusion entry flags set before entering section
#include<stdio.h>
#include<stdlib.h>
#include<unistd.h>
#include<pthread.h>
...
/*Problems : Deadlock : if both threads simultaneously enter at the same time
*/