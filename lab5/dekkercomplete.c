// Dekker Complete Solution : Using flags for entry and exit (of critical section) for synchronization 
//but to re-ensure mutual exclusion entry flags set before entering section and handle deadlocks and usage of favoured thread notion
#include<stdio.h>
#include<stdlib.h>
#include<unistd.h>
#include<pthread.h>
	...
	{	thread2WantsToEnter = true; 
		...
		{	//printf("Thread 2 waiting\n");		//wait till thread1 is executing its critical section
			...
			{	thread2WantsToEnter = false;
				while(favouredThread == 1);			//waiting for thread1 to complete
				thread2WantsToEnter = true;
			}
		}
		//enter critical section
